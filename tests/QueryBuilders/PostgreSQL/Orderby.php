...
class TestOfOrderbyPostgres extends UnitTestCase
{
...
function __construct()
	...
	function TestEmptyParam()
	{
		...
		$this->assertFalse($method->sql, 'PostgreSQL ORDER BY with no params should be false');
